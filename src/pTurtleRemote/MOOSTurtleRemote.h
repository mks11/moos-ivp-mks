...
// MOOSTurtleRemote.h: interface for the CMOOSTurtleRemote class.
//
//////////////////////////////////////////////////////////////////////
...
class CMOOSTurtleRemote : public CMOOSApp
{
public:
    ...
    CMOOSTurtleRemote();
    virtual ~CMOOSTurtleRemote();

    bool Run( const char * sName,const char * sMissionFile);

void updateString(std::string &sCurrentVelocity,
		  std::string &sCurrentRightWheelVelocity,
 std::string &sCurrentLeftWheelVelocity, std::string &sCurrentRadius);
 ...
 protected:
	...
	//double m_dfCurrentElevator; == iCurrentRightWheelVelocity, m 
	//double m_dfCurrentRudder; == iCurrentLeftWheelVelocity, n
	//double m_dfCurrentThrust;== iCurrentRadius
	// "ZERO_RUDDER" == ZERO_LEFT_WHEEL
	// ZERO_ELEVATOR == ZERO_RIGHT_WHEEL
	
	// turtle bot parameters
	int m_iCurrentVelocity;
	int  m_iCurrentRightWheelVelocity;
	int  m_iCurrentLeftWheelVelocity; 
	int m_iCurrentRadius;
	std::string m_SEND_CMD;
